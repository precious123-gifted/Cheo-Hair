...
<PrismicNextLink className="text-[#2a3b3b]  bg-[#d3cbcf] hover:text-[#2d3d3d] hover:bg-[#d4baac] duration-[1s] ease-in-out py-4  px-8 w-full rounded text-center text-[2vw] portrait:sm:text-[3vw] portrait:text-[6vw]" field={slice.primary.hairsbutton}>Check Our Hairs</PrismicNextLink>
