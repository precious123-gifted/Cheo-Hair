...
const Hero = ({ slice }: HeroProps): JSX.Element => {
  return (
    <Bounded
     ...
     className="pt-[1.8vw] portrait:pt-[4.5vw] portrait:sm:pt-[3vw] pb-5 bg-[rgb(245,236,241)]  space-y-10  portrait:space-y-80 portrait:sm:space-y-40 " >
...
<div className="header2 text-[#E5DBE1] text-[2vw] portrait:sm:text-[3vw] portrait:text-[5vw] "><PrismicRichText field={slice.primary.header2} /></div>

<div className="staricons  flex justify-center">
      <div className="content object-contain w-[15vw] portrait:w-[40vw]  portrait:sm:w-[30vw]">
