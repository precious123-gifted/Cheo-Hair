...
<div ref={heroimage} className="heroimage opacity-0 w-[22vw]  portrait:w-full    object-contain "><PrismicNextImage className="landscape:rounded-l-xl portrait:rounded-t-xl portrait:h-[80vw] object-cover object-top "   field={slice.primary.heroimage} /></div>

<div className="headersection  bg-[#141C1C] h-fit  mt-5 flex flex-col items-start w-[50%] portrait:w-full portrait:sm:w-full   space-y-6 portrait:space-y-4">
